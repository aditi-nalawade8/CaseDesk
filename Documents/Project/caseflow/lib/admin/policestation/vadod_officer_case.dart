...
class VadodbazarOfficerCaseScreen extends StatefulWidget {
  final String officerName;

  const VadodbazarOfficerCaseScreen({super.key, required this.officerName});

  @override
  State<VadodbazarOfficerCaseScreen> createState() =>
      _VadodbazarOfficerCaseScreenState();
}

class _VadodbazarOfficerCaseScreenState
    extends State<VadodbazarOfficerCaseScreen>
    with SingleTickerProviderStateMixin {
  late TabController _tabController;
  final SupabaseClient supabase = Supabase.instance.client;

  static const String policeStation = 'वडोदबाजार';
  ...
  Future<List<Map<String, dynamic>>> fetchCases(String table) async {
    try {
      ...
      debugPrint('Vadodbazar case fetch error [$table]: $e');
