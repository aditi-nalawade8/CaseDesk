import 'package:casedesk/admin/policestation/phulamb_officer_case.dart';
import 'package:flutter/material.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

class FulambriOfficerListScreen extends StatefulWidget {
  const FulambriOfficerListScreen({super.key});

  @override
  State<FulambriOfficerListScreen> createState() =>
      _FulambriOfficerListScreenState();
}

class _FulambriOfficerListScreenState extends State<FulambriOfficerListScreen> {
  ...
  /// 🔹 Fetch ALL officers of फुलंब्री
  Future<List<Map<String, dynamic>>> fetchOfficers() async {
    try {
      ...
      debugPrint('Fulambri officer fetch error: $e');
      return [];
    }
  }
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => FulambriOfficerCaseScreen(
