import 'package:casedesk/admin/policestation/karmad_officer_case.dart';
import 'package:flutter/material.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

class KarmadOfficerListScreen extends StatefulWidget {
  const KarmadOfficerListScreen({super.key});

  @override
  State<KarmadOfficerListScreen> createState() =>
      _KarmadOfficerListScreenState();
}

class _KarmadOfficerListScreenState extends State<KarmadOfficerListScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchOfficers() async {
    try {
      ...
      debugPrint('Officer fetch error (Karmad): $e');
      return [];
    }
  }
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => OfficerCasesKarmadScreen(
