import 'package:casedesk/admin/policestation/chik_officer_case.dart';
import 'package:flutter/material.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

class ChikhalthanaOfficerListScreen extends StatefulWidget {
  const ChikhalthanaOfficerListScreen({super.key});

  @override
  State<ChikhalthanaOfficerListScreen> createState() =>
      _ChikhalthanaOfficerListScreenState();
}

class _ChikhalthanaOfficerListScreenState
    extends State<ChikhalthanaOfficerListScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchOfficers() async {
    try {
      ...
      debugPrint('Officer fetch error: $e');
      return [];
    }
  }
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => OfficerCasesScreen(
                                officerName: officer['name'],
                                policeStation: 'चिकलठाणा',
                              ),
                            ),
                          );
                        },
